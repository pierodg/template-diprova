...
import it.framework.api.entity.EmployeeRowMapper;
...
public class EmployeeDaoImpl{
	...
	public Employee findById(String id) {
		...
		SqlParameterSource param = new MapSqlParameterSource().addValue("employeeId", id);
		
		return template.queryForObject(sql, param, new EmployeeRowMapper());
	}
